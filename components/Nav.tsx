...
const Nav = () => {
    ...
    return (
        <div className="bg-black z-40 px-2 py-2 flex items-center justify-between rounded-full text-white fixed top-4 left-1/2 transform -translate-x-1/2 w-full max-w-[1400px]">
